package com.example.shoppinglist.uiComponents.theme
...
fun Theme(
    ...
    LaunchedEffect(colors) {
        when (colors) {
            LightColorPalette -> activity.setTheme(R.style.Theme_ShoppingList_Light)
            TwilightColorPalette -> activity.setTheme(R.style.Theme_ShoppingList_Twilight)
            NightColorPalette -> activity.setTheme(R.style.Theme_ShoppingList_Night)
            SunriseColorPalette -> activity.setTheme(R.style.Theme_ShoppingList_Sunrise)
            AuroraColorPalette -> activity.setTheme(R.style.Theme_ShoppingList_Aurora)
        }
    }
